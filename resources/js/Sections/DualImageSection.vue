<template>
  <div class="bg-chock bgCreamAndBlack z-10">
    <div class="max-w-7xl mx-auto">
      <div class="pb-12 px-5 lg:grid-cols-2 lg:grid gap-10 lg:items-center">
    ...
    <chevron class="py-5 md:p-0" />
  </div>
</template>

<script>
import TwinImages from "@/Elements/TwinImages";
