            ...
            <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                ...
                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <td  v-for="role in user.roles" :key="role.id"  class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                            {{ role.title }}
                        </td>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                         ...
                         <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <inertia-link :href="route('users.destroy', user.id )"   class="text-indigo-600 hover:text-indigo-900">delete</inertia-link>
