                ...
                <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                            <inertia-link :href="route('products.show', product.id)" class="text-indigo-600 hover:text-indigo-900">show</inertia-link>
                            <inertia-link :href="route('products.edit', product.id)" class="text-indigo-600 hover:text-indigo-900">edit</inertia-link>
                        </td>
                         <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
