<template>
  <div>
    ...
    <div class="min-h-screen bg-slate relative">
      <nav
        class="absolute bg-slate glassClear md:bg-transparent w-full z-50 chockGlow inset"
      >
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ml-6">
              ...
              <div
                class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex relative h-full"
              >
                <jet-nav-link
                  :href="route('checkout.index')"
                  :active="route().current('checkout.index')"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="18"
                  ...
                  <span v-if="$page.props.cart !== null" class="badge">{{
                    $page.props.cart.totalQty
                  }}</span>
                </jet-nav-link>
              </div>
            </div>
        ...
        >
          <div class="pt-2 pb-3 space-y-1">
            ...
            >
              Cart
              <span
                v-if="$page.props.cart !== null"
                class="p-1 rounded-full bg-red-400 absolute"
              />
            </jet-responsive-nav-link>
          </div>
          ...
          <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
              ...
              <jet-responsive-nav-link :href="route('myorders.index')">
                My Orders
              </jet-responsive-nav-link>
